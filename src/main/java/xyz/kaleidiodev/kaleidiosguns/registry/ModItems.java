...
public class ModItems {
	...
	public static void registerItems(final RegistryEvent.Register<Item> event) {
		...
		// Pistols
		ironGun = initItem(reg, new GunItem(defP().durability(KGConfig.ironPistolDurability.get()), 0, KGConfig.ironPistolDamageMultiplier.get(), KGConfig.ironPistolFireDelay.get(), KGConfig.ironPistolInaccuracy.get(), KGConfig.ironPistolEnchantability.get(), KGConfig.ironPistolSwitchSpeed.get(), KGConfig.ironPistolMeleeDamage.get()).repair(() -> Ingredient.of(Tags.Items.INGOTS_IRON)), "pistol").projectileSpeed(KGConfig.ironPistolProjectileSpeed.get()).fireSound(ModSounds.pistol).setIsOneHanded(true).setIsJuggler(true);
		...
		skillShotPistol = initItem(reg, new GunItem(defP().durability(KGConfig.goldSkillshotDurability.get()), 0, KGConfig.goldSkillshotDamageMultiplier.get(), KGConfig.goldSkillshotFireDelay.get(), KGConfig.goldSkillshotInaccuracy.get(), KGConfig.goldSkillshotEnchantability.get(), KGConfig.goldSkillshotSwitchSpeed.get(), KGConfig.goldSkillshotMeleeDamage.get()).repair(() -> Ingredient.of(Tags.Items.INGOTS_GOLD)).setTwoHandBonus(true), "showman_glock").projectileSpeed(KGConfig.goldSkillshotProjectileSpeed.get()).fireSound(ModSounds.skillShot).setIsOneHanded(true);
