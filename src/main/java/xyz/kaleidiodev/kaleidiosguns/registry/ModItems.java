...
public class ModItems {
	...
	public static void registerItems(final RegistryEvent.Register<Item> event) {
		...
		heroShotgun = initItem(reg, new ShotgunItem(defP().durability(KGConfig.diamondShotgunDurability.get()), 0, KGConfig.diamondShotgunDamageMultiplier.get(), KGConfig.diamondShotgunFireDelay.get(), KGConfig.diamondShotgunInaccuracy.get(), KGConfig.diamondShotgunEnchantability.get(), KGConfig.diamondShotgunBulletCount.get(), KGConfig.diamondShotgunSwitchSpeed.get(), KGConfig.diamondShotgunMeleeDamage.get()).setIsWave(true).fireSound(ModSounds.heroWave).repair(() -> Ingredient.of(Tags.Items.GEMS_EMERALD)), "hero_wave_shotgun").projectileSpeed(KGConfig.diamondShotgunProjectileSpeed.get()).setCost(KGConfig.diamondShotgunCost.get()).setHero(true);
