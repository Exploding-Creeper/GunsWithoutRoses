...
public class ModItems {
	...
	public static void registerItems(final RegistryEvent.Register<Item> event) {
		...
		// Shotguns
		ironShotgun = initItem(reg, new ShotgunItem(defP().durability(KGConfig.shotgunDurability.get()), 0, KGConfig.shotgunDamageMultiplier.get(), KGConfig.shotgunFireDelay.get(), KGConfig.shotgunInaccuracy.get(), KGConfig.shotgunEnchantability.get(), KGConfig.shotgunBulletCount.get(), KGConfig.shotgunSwitchSpeed.get(), KGConfig.shotgunMeleeDamage.get()).setIsSpread(true).fireSound(ModSounds.spreadgun).repair(() -> Ingredient.of(Tags.Items.INGOTS_IRON)), "shotgun").projectileSpeed(KGConfig.shotgunProjectileSpeed.get()).setCost(KGConfig.shotgunCost.get());
		...
		diamondBoomstick = initItem(reg, new ShotgunItem(defP().durability(KGConfig.diamondBoomstickDurability.get()), 0, KGConfig.diamondBoomstickDamageMultiplier.get(), KGConfig.diamondBoomstickFireDelay.get(), KGConfig.diamondBoomstickInaccuracy.get(), KGConfig.diamondBoomstickEnchantability.get(), KGConfig.diamondBoomstickBulletCount.get(), KGConfig.diamondBoomstickSwitchSpeed.get(), KGConfig.diamondBoomstickMeleeDamage.get()).fireSound(ModSounds.shotgun).repair(() -> Ingredient.of(Tags.Items.GEMS_DIAMOND)), "boom_stick").projectileSpeed(KGConfig.diamondBoomstickProjectileSpeed.get()).setCost(KGConfig.diamondBoomstickCost.get()).setBreachDoors(true);
